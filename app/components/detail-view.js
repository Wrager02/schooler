...
app.controller("DetailViewController", function ($log, $stateParams, FilterByIdService, $timeout) {
    ...
    FilterByIdService.filterByID(this.id).then(response => {
        ...
        document.getElementById("map").innerHTML =
            "<iframe frameborder=\"0\" style=\"border:0;\" src=\"https://www.google.com/maps/embed/v1/place?q=" + this.school.name + "," + this.school.city+ "&key=AIzaSyBpl8WLJuPi3SuXpXezbMuZeubiaozm2gM\" allowfullscreen></iframe>"
        ;
    });
